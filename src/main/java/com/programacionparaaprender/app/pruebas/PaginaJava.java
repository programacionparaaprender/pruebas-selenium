...
@Data
@AllArgsConstructor
public class PaginaJava  implements Runnable {
	...
	public PaginaJava(String urlWeb, int id, int sleep, String version, int menuSeleccionado, int subMenuSeleccionado) {
		this.urlWeb = urlWeb;
		this.id = id;
		this.sleep = sleep;
	}
	...
	public void run() {
		try{
			if(true) {
				...
				driver.navigate();
				WebElement link1 = driver.findElement(By.linkText("Contact Sales"));
